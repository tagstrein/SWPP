\def \currentAuthor {David Nößig \& Tamara Gstrein} %so kann jederzeit der Autor geändert werden -> wird in der Fusszeile angezeigt.
...
Das Hauptziel ist eine App zu entwickeln mit der Funktion, wenn Sie die bekannten Brunnen der Gemeinde Imst besucht haben werden Sie durch Punkte belohnt. Diese Punkte dienen dazu, dass Sie später zu Sehenswürdigkeiten in Imst mit Ermäßigung anschauen können.
Das Projekt sollte bis Mitte Mai 2017 fertig sein.
...
\begin{itemize}
	...
	Wir entwickeln eine App  mit der Sie bekannte Brunnen der Stadt Imst besuchen können, wenn Sie so einen Brunnen besucht haben werden auf Ihrer App Punkte gesammelt. Mit diesen Punkten sammeln Sie Ermäßigungen zu bestimmte Sehenswürdigkeiten in Imst. 
	\item 
	Es gibt noch kein solches Projekt, nur ein Ähnliches. Dieses heißt Pokemon Go.
	\item 
...
\begin{itemize}
	...
	Man muss ein Smarthphone mit dieser App besitzen.
	\begin{itemize}
		\item Funktional
		GPS, Internetverbindung
		\item Nicht-funktional
		immer Online und funktioniert immer
	\end{itemize}
...
\begin{itemize}
	\item HTML 5: Vernetzung von Texten und anderen Inhalten elektronischer Dokumente\\
	CSS: zum Gestalten der HTML-Datei\\
	JAVA SCRIPT: Benutzerinteraktionen auswerten, Inhalte verändern oder generieren\\
	SQL: Datenbankstruktur in relationaler Datenbank sowie bearbeiten und abfragen basierender Datenbestände
	\item HTML 5: Gestaltung der Oberfläche\\
	CSS: Design der Oberfläche\\
	JAVA SCRIPT: \\
	SQL: Anlegen und Verwalten der Datenbank
